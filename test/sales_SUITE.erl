...
test__save_invoice(_Config) ->
    ...
    Invoice = #invoice{type = sales, bpartner = "c1", doc_no = "SI-10", trx_ts = "2023-01-01", total = 100, discount = 0,
             lines = [#invoice_line{line_no = 10, product = "p1", qty = 5, price = 15, line_amt=75},
