...
main(Args) ->
    OptSpec =
        [
            ...
            {n_vendors, undefined, "vendors", {integer, 0}, "limit the number of unique vendors"},
...
dump(
    ...
    file:write_file(
        filename:join(Outdir, "inventories.csv"),
    ...
    case SInvoices of
        ...
        _ ->
            file:write_file(
                filename:join(Outdir, "sinvoices.csv"),
    ...
    case PInvoices of
        ...
        _ ->
            file:write_file(
                filename:join(Outdir, "pinvoices.csv"),
...
gen_invoices(Type, N, MaxNLines, Data) ->
    ...
    ComputeTotal =
        fun(Lines, Discount) ->
            SumLineAmt =
                lists:foldl(
                    fun(#invoice_line{line_amt = Amt}, Acc) ->
                        Amt + Acc
                    end,
                    0.0,
                    Lines
