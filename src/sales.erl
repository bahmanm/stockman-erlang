...
save_invoice(#invoice{type=Type, doc_no=DocNo, lines=Lines}=Invoice,
...
save_invoice_test() ->
    ...
    Invoices0 = dict:new(),
    Invoice0 = #invoice{doc_no="i1", type=sales,
    ...
    Invoice1 = #invoice{doc_no="i2", type=sales,
...
save_invoices_test() ->
    ...
    ToSave = dict:from_list([
                              {"i1",
                               #invoice{doc_no="i1", type=sales,
                                        lines=[#invoice_line{
                                                  line_no=1, product="p1", qty=8},
                                               #invoice_line{
                                                  line_no=2, product="p2", qty=2}]}},
                              {"i2",
                               #invoice{doc_no="i2", type=sales,
                                        lines=[#invoice_line{
